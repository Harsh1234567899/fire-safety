...
import { createCylinder } from '../services/fireExtinguisher';
import { createNOC } from '../services/fireNoc';
import { createAMC } from '../services/amc';
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="date" value={item.startDate} onChange={(e) => updateItem(item.id, 'CYLINDERS', 'startDate', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/4 text-gray-400 pointer-events-none z-10" size={16} />
                                            <input type="date" value={item.renewalDate} onChange={(e) => updateItem(item.id, 'CYLINDERS', 'renewalDate', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div key={item.id} className="bg-gray-50 p-8 rounded-[2rem] mb-6 border border-gray-100 flex flex-col gap-6 relative group/item hover:border-blue-100 transition-all">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/4 text-gray-400 pointer-events-none z-10" size={16} />
                                            <input type="date" value={item.startDate} onChange={(e) => updateItem(item.id, 'NOC', 'startDate', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/4 text-gray-400 pointer-events-none z-10" size={16} />
                                            <input type="date" value={item.expiry} onChange={(e) => updateItem(item.id, 'NOC', 'expiry', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div key={item.id} className="bg-gray-50 p-8 rounded-[2rem] mb-6 border border-gray-100 flex flex-col gap-6 relative group/item hover:border-purple-100 transition-all">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/4 text-gray-400 pointer-events-none z-10" size={16} />
                                            <input type="date" value={item.startDate} onChange={(e) => updateItem(item.id, 'AMC', 'startDate', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Renewal Target (Expiry)</label>
                                        <div className="relative">
                                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/4 text-gray-400 pointer-events-none z-10" size={16} />
                                            <input type="date" value={item.expiry} onChange={(e) => updateItem(item.id, 'AMC', 'expiry', e.target.value)} className="w-full bg-white rounded-xl pl-4 pr-11 py-3 text-sm font-bold outline-none border border-gray-100 shadow-sm text-gray-900" />
                                        </div>
                                    </div>
